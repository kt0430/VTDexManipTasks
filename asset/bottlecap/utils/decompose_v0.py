...
def export_urdf(
    ...
    for piece in convex_pieces:
        ...
        if link_name[5::] == cap_name:
            et.SubElement(inertial, 'origin', xyz="0 0 0.002", rpy="0 0 0")
        else:
            et.SubElement(inertial, 'origin', xyz="0 0 0", rpy="0 0 0")
        et.SubElement(inertial, 'mass', value='{:.2E}'.format(0.01))
        # et.SubElement(
        #     inertial,
        #     'inertia',
        #     ixx='0.005',
        ...
        if prev_link_name is not None:
            # Create revolute joint to the first link (bottle cap)
            if link_name[5::] == cap_name:
                ...
                # et.SubElement(joint, 'limit', effort="10")
